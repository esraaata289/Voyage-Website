      ...
      <form method="post">
       <div class="team jarallax" id="team" style="margin-top:20px;">
		<div class="container">
		   ...
		   $sql=" select * from country where country_name like '%$_GET[search]%'";
		      ...
		      ?>
				<div class="col-md-3 agile_team_grid" >
					<div class="view w3-agile-view">
						<img src="country/<?php echo($row['country_no']) ?>.jpg" width="600px" height="400px" alt=" " class="img-responsive" />
						
							<h4><?php echo($row['country_name']) ?></h4>
                        <div class="w3lmask">
                            <h5><p> If You Want To Know  More About <span style="color:black"><?php echo($row['country_name']) ?></span> Enter   From Here..... </p></h5>
							<div class="social">
								<ul>
                                    <li><a href="citybefore.php?CountryNo=<?php echo($row['country_no']) ?>"><i class="fa fa-arrow-right" aria-hidden="true"></i> </a></li>
