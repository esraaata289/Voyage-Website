                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Places</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner res-mg-b-30">
                            <div class="courses-title">
                                <a href="#"><img src="../place/<?php echo($row['place_no']) ?>.jpg" alt=""></a>
                                <h2><?php echo($row['place_name']) ?></h2>
                            </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">All Hotels</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
		    ...
		    while($row = mysqli_fetch_assoc($qry)) 
		      ...
		      ?>
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="courses-inner res-mg-b-30">
                            <div class="courses-title">
                                <a href="#"><img src="../hotel/<?php echo($row['hotel_no']) ?>.jpg" alt=""></a>
